...
inherit base git-2 systemd unpacker python-single-r1
...
src_install() {
	...
	doins modules/lua-core/src/*

	insinto /usr/lib/aerospike/udf/lua/external
	doins modules/lua-core/src/external/*

	insinto /usr/lib/aerospike/udf/lua/ldt
	doins modules/lua-core/src/ldt/*
